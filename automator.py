...
def chat(message: str) -> str:
    ...
    try:
        messages = [{"role": "system", "content": (
            ...
            "- Максимально подробными и развёрнутыми\n"
            "- С примерами, цифрами, фактами\n"
            "- С подзаголовками, списками, структурой\n"
            "- На русском языке, если вопрос задан на русском\n"
            "- Длинными — не сокращай ответы, давай исчерпывающую информацию\n"
            "- С личным обращением, дружелюбным тоном\n"
            "- Если тема сложная — разбивай на блоки с примерами\n"
            "- Всегда добавляй практические советы и рекомендации\n"
            "Помни: ты должен отвечать ТАК ЖЕ подробно, как ChatGPT на сайте OpenAI. "
            "Никогда не сокращай ответы. Давай максимум полезной информации."
        )}]
