...
<div style="text-align:center;padding:20px;font-size:11px;color:#999;background:var(--bg)">ИНН: 526320301575 &middot; ИП Маширов С.Д. &middot; <a href="/legal" style="color:#999;text-decoration:underline">Публичная оферта</a> &middot; <a href="/pricing" style="color:#999;text-decoration:underline">Тарифы</a></div>
